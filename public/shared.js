...
fr:{
  ...
  // Alias UI (compat pages older keys)
  ui_create_room:'Créer la salle',
  ui_join_code:'Rejoindre (code)',
  ui_join:'Rejoindre',
  ui_join_arrow:'Rejoindre →',
  ui_pseudo_ph:'Ton pseudo',
  ui_your_name_ph:'Votre prénom',
  ...
  // Quiz
  quiz_waiting:'En attente...',
  quiz_players_connected:'{n} joueur connecté|{n} joueurs connectés',
  quiz_read_question:'⏳ Lis la question...',
  quiz_you_buzzed:'Tu as buzzé ! Choisis ta réponse...',
  quiz_player_buzzed:'{name} a buzzé !',
  quiz_time_up:'Temps écoulé ! Personne n\'a répondu.',
  quiz_points:'+{n} point|+{n} points',
  quiz_wrong:'Mauvaise réponse...',
  quiz_draw:'Égalité — match nul !',
  quiz_you_win:'Tu as gagné ! Félicitations !',
  quiz_x_wins:'{name} a gagné !',
  quiz_code_wait:'Code : {code} — En attente de joueurs…',
  quiz_host_ready:'{n} joueur — lance quand tu es prêt !|{n} joueurs — lance quand tu es prêt !',
  quiz_wait_host:'En attente que {name} lance…',
  quiz_title:'Quiz Éclair',
  quiz_tagline:'Buzzez le premier !',
  quiz_sound_toggle_title:'Sons on/off',
  quiz_prepare:'Préparez-vous !',
  quiz_room_code_label:'Code de votre salle',
  quiz_click_copy:'Cliquer pour copier',
  quiz_copied:'Copié !',
  quiz_categories:'Catégories',
  quiz_cat_geo:'Géographie',
  quiz_cat_histoire:'Histoire',
  quiz_cat_sciences:'Sciences',
  quiz_cat_cinema:'Cinéma &amp; TV',
  quiz_cat_musique:'Musique',
  quiz_cat_sport:'Sport',
  quiz_cat_cuisine:'Gastronomie',
  quiz_cat_tech:'Tech',
  quiz_cat_culture:'Culture',
  quiz_difficulty:'Difficulté',
  quiz_diff_all:'Toutes',
  quiz_diff_easy:'Facile',
  quiz_diff_med:'Moyen',
  quiz_diff_hard:'Difficile',
  quiz_qcount:'Nombre de questions',
  quiz_custom_toggle:'+ Questions personnalisées',
  quiz_custom_q_ph:'Votre question...',
  quiz_custom_a_ph:'Réponse A',
  quiz_custom_b_ph:'Réponse B',
  quiz_custom_c_ph:'Réponse C',
  quiz_custom_d_ph:'Réponse D',
  quiz_custom_correct:'Bonne réponse :',
  quiz_custom_add:'Ajouter',
  quiz_fill_all:'Remplis tous les champs !',
  quiz_start_btn:'Lancer la partie !',
  quiz_enter_name:'Entre ton prénom !',
  quiz_enter_code:'Entre le code de la salle !',
  quiz_player_left:'{name} a quitté.',
  quiz_abandoned:'Tous les autres joueurs ont quitté — partie abandonnée !',
  quiz_q_xof:'Question {cur} / {total}',
  quiz_streak_bonus:' + Bonus série !',
  quiz_speed_bonus:' ⚡+1 Bonus Vitesse !',
  quiz_second_chance:'(2ème chance)',
  quiz_second_for_you:'Deuxième chance pour toi !',
  quiz_second_for_x:'Deuxième chance pour {name} !',
  quiz_x_points:'{name} : +{n} pt|{name} : +{n} pts',
  quiz_x_wrong:'{name} s\'est trompé !',
  quiz_reading:'⏳ Lis la question...',
  quiz_pts:'pts',
  quiz_win_count:'{n} victoire|{n} victoires',

  // Uno
  uno_copied:'Copié !',
  uno_click_copy:'Cliquer pour copier',
  uno_wait_room:'En attente des joueurs (2–4)…',
  uno_start:'▶ Démarrer la partie',
  uno_said:'UNO annoncé !',
  uno_other_said:'{name} dit UNO !',
  uno_caught:'{catcher} attrape {target} sans UNO ! +2 cartes !',
  uno_you_played:'Tu as joué {card}',
  uno_x_played:'{name} a joué {card}',
  uno_you_draw:'Tu pioches {n} carte !|Tu pioches {n} cartes !',
  uno_x_draw:'{name} pioche {n} carte !|{name} pioche {n} cartes !',
  uno_dir_cw:'Sens horaire',
  uno_dir_ccw:'Sens anti-horaire',
  uno_stack:'+{n} carte en attente ⚠|+{n} cartes en attente ⚠',
  uno_draw_must:'+{n} Piocher (obligatoire)',
  uno_draw_one:'+1 Piocher',
  uno_turn_badge:'C\'est ton tour !',
  uno_hand:'Ta main',
  uno_over_title:'Fin de partie',
  uno_back_home:'Retour à l\'accueil',
  uno_win_me:'Tu as gagné !',
  uno_win_other:'{name} a gagné !',
  uno_win_me_sub:'Bravo, tu as vidé ta main !',
  uno_win_other_sub:'Meilleure chance la prochaine fois !',
  uno_catch_btn:'👉 Attraper {name} (sans UNO !)',
  uno_classic:'Le jeu de cartes classique !',
  uno_room_code:'Code de la salle',
  uno_waiting_players:'En attente des joueurs (2–4)…',
  uno_start_btn:'▶ Démarrer la partie',
  uno_clockwise:'Sens horaire',
  uno_counter_clockwise:'Sens anti-horaire',
  uno_draw_title:'Piocher',
  uno_my_turn:'C\'est ton tour !',
  uno_draw_stack:'+{n} carte en attente ⚠|+{n} cartes en attente ⚠',
  uno_draw_btn_one:'+1 Piocher',
  uno_draw_btn_stack:'+{n} Piocher (obligatoire)',
  uno_uno_btn:'UNO !',
  uno_uno_btn_flash:'UNO ! ⚡',
  uno_hand_label:'Ta main',
  uno_choose_color:'Choisir une couleur',
  uno_color_red:'Rouge',
  uno_color_blue:'Bleu',
  uno_color_green:'Vert',
  uno_color_yellow:'Jaune',
  uno_player_left:'{name} a quitté.',
  uno_player_left_generic:'Un joueur a quitté.',
  uno_over_title2:'Fin de partie',
  uno_back_home2:'Retour à l\'accueil',
  uno_skip:'Passe',
  uno_reverse:'Inversion',
  uno_you_draw_verb:'Tu pioches',
  uno_x_draw_verb:'{name} pioche',
  uno_cards:'{n} carte|{n} cartes',
  uno_catch_label:'👉 Attraper {name} (sans UNO !)',
  uno_no_uno:'(sans UNO !)',
  uno_penalty:'+2 cartes !',

  // Taboo (Mots Interdits)
  tab_title:'Mots Interdits',
  tab_enter_name:'Entre ton prénom pour rejoindre',
  tab_name_ph:'Ton prénom',
  tab_waiting:'En attente…',
  tab_share_code:'Partage le code à tes amis',
  tab_room_code:'Code de la salle',
  tab_click_copy:'Cliquer pour copier',
  tab_copied:'Copié !',
  tab_ready:'Prêt à jouer !',
  tab_ready_wait_host:'En attente que l\'hôte lance...',
  tab_ready_wait_players:'En attente de joueurs...',
  tab_start:'Lancer la partie',
  tab_turn:'Tour {cur}/{total} — {who}',
  tab_you_describe:'C\'est à toi de décrire !',
  tab_x_describes:'C\'est à {name} de décrire',
  tab_word_to_guess:'Mot à faire deviner :',
  tab_forbidden_words:'Mots interdits :',
  tab_describer_hint:'Le descripteur décrit un mot de {n} lettres',
  tab_your_answer_ph:'Ta réponse…',
  tab_guess_btn:'Deviner',
  tab_attempts:'Tentatives',
  tab_waiting_other:'C\'est à l\'autre de décrire…',
  tab_word_was:'Le mot était :',
  tab_next_round:'Prochain tour dans {s}s…',
  tab_reveal_guessed:'✅ Deviné !',
  tab_reveal_not_guessed:'❌ Non deviné',
  tab_game_over:'Partie terminée !',
  tab_home:'Accueil',
  tab_replay:'Rejouer',
  tab_player_left:'{name} a quitté la partie.',
  tab_player_left_generic:'Un joueur a quitté la partie.',
  tab_abandoned:'Tous les joueurs ont quitté — partie abandonnée !',
  tab_winner:'🏆 {name} remporte la partie !',
  tab_tie:'🤝 Égalité !',
  tab_pts:'pts',

  // Emoji (Devinette Emoji)
  emo_title:'Devinette Emoji',
  emo_enter_name:'Entre ton prénom pour rejoindre',
  emo_name_ph:'Ton prénom',
  emo_waiting:'En attente…',
  emo_share_code:'Partage le code à tes amis',
  emo_room_code:'Code de la salle',
  emo_click_copy:'Cliquer pour copier',
  emo_copied:'Copié !',
  emo_ready:'Prêts !',
  emo_start:'Lancer la partie',
  emo_wait_p1:'En attente du joueur 1…',
  emo_wait_players:'En attente de joueurs...',
  emo_question:'Question {cur}/{total}',
  emo_category:'Catégorie',
  emo_answer_ph:'Ta réponse…',
  emo_validate:'Valider',
  emo_correct:'✅ Bonne réponse ! +{n} pts',
  emo_x_found:'{name} a trouvé ! (+{n} pts)',
  emo_wrong:'❌ Mauvaise réponse…',
  emo_player_left:'{name} a quitté.',
  emo_player_left_generic:'Un joueur a quitté.',
  emo_abandoned:'Tous les joueurs ont quitté — partie abandonnée !',
  emo_x_found_list:'{names} ont trouvé !',
  emo_nobody_found:'Personne n\'a trouvé.',
  emo_game_over:'Partie terminée !',
  emo_replay:'Rejouer',
  emo_tie:'🤝 Égalité !',
  emo_you_win:'🏆 Tu remportes la partie !',
  emo_x_wins:'🏆 {name} remporte la partie !',
  emo_wins_count:'{n} victoire(s)',

  // Anagramme
  ana_title:'Anagramme',
  ana_tagline:'Déchiffre le mot avant les autres ! 8 manches · 2–4 joueurs',
  ana_room_code:'CODE DE LA SALLE',
  ana_click_copy:'Cliquer pour copier',
  ana_start:'▶ Lancer',
  ana_wait_launch:'En attente du lancement…',
  ana_wait_p1:'En attente du joueur 1…',
  ana_round:'MANCHE {cur}/{total}',
  ana_wrong:'✗ Mauvaise réponse !',
  ana_you_found:'🎉 Tu as trouvé !',
  ana_x_found:'{name} a trouvé !',
  ana_timeout:'Temps écoulé — personne n\'a trouvé',
  ana_pts:'{n} pts',
  ana_x_wins:'{name} gagne !',
  ana_abandoned:'Un joueur a quitté.',

  // Paint.io
  paint_title:'Paint.io',
  paint_skins_label:'Thème &amp; skins',
  paint_skins_aria:'Thème visuel Paint.io',
  paint_start:'Lancer la partie',
  paint_over_you_win:'Victoire !',
  paint_over_x_win:'{name} gagne !',
  paint_enter_name:'Entre ton pseudo',
  paint_name_code_required:'Nom + code requis',
  paint_player_left:'{name} a quitté.',
  paint_player_left_generic:'Un joueur a quitté.',
  paint_eliminated:'{name} a été éliminé !'
},
en:{
  ...
  // UI aliases (legacy keys)
  ui_create_room:'Create room',
  ui_join_code:'Join (code)',
  ui_join:'Join',
  ui_join_arrow:'Join →',
  ui_pseudo_ph:'Your name',
  ui_your_name_ph:'Your name',
  ...
  // Quiz
  quiz_waiting:'Waiting...',
  quiz_players_connected:'{n} player connected|{n} players connected',
  quiz_read_question:'⏳ Read the question...',
  quiz_you_buzzed:'You buzzed! Choose your answer...',
  quiz_player_buzzed:'{name} buzzed!',
  quiz_time_up:'Time\'s up! Nobody answered.',
  quiz_points:'+{n} point|+{n} points',
  quiz_wrong:'Wrong answer...',
  quiz_draw:'Draw — tied game!',
  quiz_you_win:'You won! Congratulations!',
  quiz_x_wins:'{name} won!',
  quiz_code_wait:'Code: {code} — waiting for players…',
  quiz_host_ready:'{n} player — start when you\'re ready!|{n} players — start when you\'re ready!',
  quiz_wait_host:'Waiting for {name} to start…',
  quiz_title:'Flash Quiz',
  quiz_tagline:'Buzz first!',
  quiz_sound_toggle_title:'Sound on/off',
  quiz_prepare:'Get ready!',
  quiz_room_code_label:'Your room code',
  quiz_click_copy:'Click to copy',
  quiz_copied:'Copied!',
  quiz_categories:'Categories',
  quiz_cat_geo:'Geography',
  quiz_cat_histoire:'History',
  quiz_cat_sciences:'Science',
  quiz_cat_cinema:'Movies &amp; TV',
  quiz_cat_musique:'Music',
  quiz_cat_sport:'Sports',
  quiz_cat_cuisine:'Food',
  quiz_cat_tech:'Tech',
  quiz_cat_culture:'Culture',
  quiz_difficulty:'Difficulty',
  quiz_diff_all:'All',
  quiz_diff_easy:'Easy',
  quiz_diff_med:'Medium',
  quiz_diff_hard:'Hard',
  quiz_qcount:'Number of questions',
  quiz_custom_toggle:'+ Custom questions',
  quiz_custom_q_ph:'Your question...',
  quiz_custom_a_ph:'Answer A',
  quiz_custom_b_ph:'Answer B',
  quiz_custom_c_ph:'Answer C',
  quiz_custom_d_ph:'Answer D',
  quiz_custom_correct:'Correct answer:',
  quiz_custom_add:'Add',
  quiz_fill_all:'Fill all fields!',
  quiz_start_btn:'Start game!',
  quiz_enter_name:'Enter your name!',
  quiz_enter_code:'Enter the room code!',
  quiz_player_left:'{name} left.',
  quiz_abandoned:'All other players left — game abandoned!',
  quiz_q_xof:'Question {cur} / {total}',
  quiz_streak_bonus:' + Streak bonus!',
  quiz_speed_bonus:' ⚡+1 Speed bonus!',
  quiz_second_chance:'(2nd chance)',
  quiz_second_for_you:'Second chance for you!',
  quiz_second_for_x:'Second chance for {name}!',
  quiz_x_points:'{name}: +{n} pt|{name}: +{n} pts',
  quiz_x_wrong:'{name} got it wrong!',
  quiz_reading:'⏳ Read the question...',
  quiz_pts:'pts',
  quiz_win_count:'{n} win|{n} wins',

  // Uno
  uno_copied:'Copied!',
  uno_click_copy:'Click to copy',
  uno_wait_room:'Waiting for players (2–4)…',
  uno_start:'▶ Start the game',
  uno_said:'UNO said!',
  uno_other_said:'{name} says UNO!',
  uno_caught:'{catcher} catches {target} without UNO! +2 cards!',
  uno_you_played:'You played {card}',
  uno_x_played:'{name} played {card}',
  uno_you_draw:'You draw {n} card!|You draw {n} cards!',
  uno_x_draw:'{name} draws {n} card!|{name} draws {n} cards!',
  uno_dir_cw:'Clockwise',
  uno_dir_ccw:'Counter-clockwise',
  uno_stack:'+{n} card pending ⚠|+{n} cards pending ⚠',
  uno_draw_must:'+{n} Draw (mandatory)',
  uno_draw_one:'+1 Draw',
  uno_turn_badge:'It\'s your turn!',
  uno_hand:'Your hand',
  uno_over_title:'Game over',
  uno_back_home:'Back to home',
  uno_win_me:'You won!',
  uno_win_other:'{name} won!',
  uno_win_me_sub:'Well done, you emptied your hand!',
  uno_win_other_sub:'Better luck next time!',
  uno_catch_btn:'👉 Catch {name} (no UNO!)',
  uno_classic:'The classic card game!',
  uno_room_code:'Room code',
  uno_waiting_players:'Waiting for players (2–4)…',
  uno_start_btn:'▶ Start the game',
  uno_clockwise:'Clockwise',
  uno_counter_clockwise:'Counter-clockwise',
  uno_draw_title:'Draw',
  uno_my_turn:'It\'s your turn!',
  uno_draw_stack:'+{n} card pending ⚠|+{n} cards pending ⚠',
  uno_draw_btn_one:'+1 Draw',
  uno_draw_btn_stack:'+{n} Draw (mandatory)',
  uno_uno_btn:'UNO!',
  uno_uno_btn_flash:'UNO! ⚡',
  uno_hand_label:'Your hand',
  uno_choose_color:'Choose a color',
  uno_color_red:'Red',
  uno_color_blue:'Blue',
  uno_color_green:'Green',
  uno_color_yellow:'Yellow',
  uno_player_left:'{name} left.',
  uno_player_left_generic:'A player left.',
  uno_over_title2:'Game over',
  uno_back_home2:'Back to home',
  uno_skip:'Skip',
  uno_reverse:'Reverse',
  uno_you_draw_verb:'You draw',
  uno_x_draw_verb:'{name} draws',
  uno_cards:'{n} card|{n} cards',
  uno_catch_label:'👉 Catch {name} (no UNO!)',
  uno_no_uno:'(no UNO!)',
  uno_penalty:'+2 cards!',

  // Taboo
  tab_title:'Taboo',
  tab_enter_name:'Enter your name to join',
  tab_name_ph:'Your name',
  tab_waiting:'Waiting…',
  tab_room_code:'Room code',
  tab_click_copy:'Click to copy',
  tab_copied:'Copied!',
  tab_share:'Share the code with your friends',
  tab_ready:'Ready to play!',
  tab_players_ready:'{names}',
  tab_start:'Start game',
  tab_wait_p1:'Waiting for player 1…',
  tab_wait_players:'Waiting for players...',
  tab_wait_host:'Waiting for host to start...',
  tab_turn_info:'Round {cur}/{total} — {who}',
  tab_you_describe:'It\'s your turn to describe!',
  tab_x_describes:'{name} is describing',
  tab_word_to_guess:'Word to guess:',
  tab_forbidden:'Forbidden words:',
  tab_word_hint:'The describer is describing a {n}-letter word',
  tab_answer_ph:'Your answer…',
  tab_guess:'Guess',
  tab_grille:'🚫 FAIL!',
  tab_attempts:'Attempts',
  tab_other_describes:'Someone else is describing…',
  tab_word_was:'The word was:',
  tab_next_round:'Next round in {s}s…',
  tab_reveal_guessed:'✅ Guessed!',
  tab_reveal_not_guessed:'❌ Not guessed',
  tab_game_over:'Game over!',
  tab_home:'Home',
  tab_replay:'Play again',
  tab_player_left:'{name} left the game.',
  tab_player_left_generic:'A player left the game.',
  tab_abandoned:'All players left — game abandoned!',
  tab_winner:'🏆 {name} wins the game!',
  tab_tie:'🤝 Tie!',
  tab_pts:'pts',

  // Emoji (Emoji Quiz)
  emo_title:'Emoji Quiz',
  emo_enter_name:'Enter your name to join',
  emo_name_ph:'Your name',
  emo_waiting:'Waiting…',
  emo_share_code:'Share the code with your friends',
  emo_room_code:'Room code',
  emo_click_copy:'Click to copy',
  emo_copied:'Copied!',
  emo_ready:'Ready!',
  emo_start:'Start game',
  emo_wait_p1:'Waiting for player 1…',
  emo_wait_players:'Waiting for players...',
  emo_question:'Question {cur}/{total}',
  emo_category:'Category',
  emo_answer_ph:'Your answer…',
  emo_validate:'Submit',
  emo_correct:'✅ Correct! +{n} pts',
  emo_x_found:'{name} found it! (+{n} pts)',
  emo_wrong:'❌ Wrong answer…',
  emo_player_left:'{name} left.',
  emo_player_left_generic:'A player left.',
  emo_abandoned:'All players left — game abandoned!',
  emo_x_found_list:'{names} found it!',
  emo_nobody_found:'Nobody found it.',
  emo_game_over:'Game over!',
  emo_replay:'Play again',
  emo_tie:'🤝 Tie!',
  emo_you_win:'🏆 You win!',
  emo_x_wins:'🏆 {name} wins!',
  emo_wins_count:'{n} win(s)',

  // Anagram
  ana_title:'Anagram',
  ana_tagline:'Unscramble the word before the others! 8 rounds · 2–4 players',
  ana_room_code:'ROOM CODE',
  ana_click_copy:'Click to copy',
  ana_start:'▶ Start',
  ana_wait_launch:'Waiting to start…',
  ana_wait_p1:'Waiting for player 1…',
  ana_round:'ROUND {cur}/{total}',
  ana_wrong:'✗ Wrong answer!',
  ana_you_found:'🎉 You found it!',
  ana_x_found:'{name} found it!',
  ana_timeout:'Time\'s up — nobody found it',
  ana_pts:'{n} pts',
  ana_x_wins:'{name} wins!',
  ana_abandoned:'A player left.',

  // Paint.io
  paint_title:'Paint.io',
  paint_skins_label:'Theme &amp; skins',
  paint_skins_aria:'Paint.io visual theme',
  paint_start:'Start game',
  paint_over_you_win:'Victory!',
  paint_over_x_win:'{name} wins!',
  paint_enter_name:'Enter your name',
  paint_name_code_required:'Name + code required',
  paint_player_left:'{name} left.',
  paint_player_left_generic:'A player left.',
  paint_eliminated:'{name} was eliminated!'
}};
...
// Pluriels via séparateur "singulier|pluriel"
function tc(key,n,vars){
  const raw = t(key, { ...(vars||{}), n });
  if(typeof raw !== 'string') return String(raw);
  const parts = raw.split('|');
  if(parts.length<=1) return raw;
  return (Number(n)===1 ? parts[0] : parts[1]).replace('{n}', String(n));
}
...
window.ZapPlay={
  ...
  showWelcomeScreen,
  t,tc,setLang,applyLang,roomsLabel,
  getLang:()=>currentLang
};
