...
test('accueil (index.html) utilise le même loader (zp-loader + shared.js)', () => {
  ...
  assert.ok(!idx.includes('id="loader"'), 'plus de #loader landing');
  assert.ok(!idx.includes('id="page-loader"'), 'plus de #page-loader');
});
